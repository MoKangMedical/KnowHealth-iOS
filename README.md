...
KnowHealth-iOS - Medical AI Project
...
1. **构建镜像**
```bash
docker build -t KnowHealth-iOS .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name KnowHealth-iOS KnowHealth-iOS
```
...
- **项目主页**: https://github.com/MoKangMedical/KnowHealth-iOS
- **问题反馈**: https://github.com/MoKangMedical/KnowHealth-iOS/issues
